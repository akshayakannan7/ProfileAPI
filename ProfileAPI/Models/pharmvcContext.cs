...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=KANINI-LTP-485\\SQLSERVERAKSHU;Database=pharmvc;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AddtoCart>(entity =>
            {
                entity.HasKey(e => e.Cartid)
                    .HasName("PK__AddtoCar__5189E1EF03AF9C36");
            ...
            modelBuilder.Entity<CustomerDetail>(entity =>
            {
                entity.HasKey(e => e.Userid)
                    .HasName("PK__Customer__1797D024C5943B2B");
            ...
            modelBuilder.Entity<ProductDetail>(entity =>
            {
                entity.HasKey(e => e.Productid)
                    .HasName("PK__ProductD__B40F3AA57D08597D");
